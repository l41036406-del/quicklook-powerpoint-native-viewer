...
{
    internal sealed class PowerPointImagePreviewControl : UserControl, IDisposable
    {
        ...
        public PowerPointImagePreviewControl(string path)
        {
            _path = path;
            ...
            _image = new Image { Stretch = Stretch.Uniform, Focusable = false };
        ...
        private async void Start()
        {
            ...
            {
                SetStatus("PowerPoint image preview failed: " + ex.Message);
                UpdateButtons();
            }
        }
